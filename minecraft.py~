...
@app.route('/')
def home():
    cur = g.db.execute('SELECT announcement, details, announcements.id, announcements.user, b.nation, Timestamp FROM announcements JOIN users as b ON announcements.user = b.user ORDER BY announcements.id DESC LIMIT 5')
