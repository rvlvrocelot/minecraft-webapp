...
@app.route('/')
def home():
    cur = g.db.execute('SELECT announcement, details, id, user, b.nation, Timestamp FROM announcements JOIN users as b ON announcements.user = b.user ORDER BY id DESC LIMIT 5')
